...
if js.length < MAX_WIDTH
	...
	html = "<div id=d></div><canvas id=c></canvas><canvas id=l><img onload=with(c.getContext('2d'))for(p=e='';drawImage(this,p--,0),t=getImageData(0,0,1,1).data[0];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
else
	js = "\x00" + js
	width = MAX_WIDTH
	...
	html = "<div id=d></div><div id=ddd></div><canvas id=l></canvas><canvas id=c><img onload=for(w=c.width=#{width},a=c.getContext('2d'),a.drawImage(this,p=0,0),e='',da=a.getImageData(0,0,w,#{height}).data;t=da[p+=4];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
end
